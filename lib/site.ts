...
export const communitySections = [
  {
    ...
    label: '전체',
    title: '전체 커뮤니티',
    description: '커뮤니티의 모든 소식을 확인하실 수 있습니다.',
    category: null,
  },
  {
    slug: 'share',
    ...
    label: '나눔',
    title: '나눔 페이지',
    description: '서로의 은혜와 일상을 따뜻하게 나누는 공간입니다.',
    category: '나눔',
  },
  {
    slug: 'prayer',
    ...
    label: '기도',
    title: '기도 페이지',
    description: '마음을 모아 서로를 위해 중보하며 기도합니다.',
    category: '기도',
  },
  {
    slug: 'youth',
    ...
    label: '청년부',
    title: '청년부 페이지',
    description: '청년부만의 활기찬 소식과 모임 이야기입니다.',
    category: '청년부',
  },
  {
    slug: 'notice',
    ...
    label: '공지',
    title: '공지 페이지',
    description: '커뮤니티 이용에 필요한 안내 사항입니다.',
    category: '공지',
  },
  {
    slug: 'other',
    ...
    label: '기타',
    title: '기타 페이지',
    description: '다양한 주제로 소통하는 자유로운 공간입니다.',
    category: '기타',
  },
] as const;
